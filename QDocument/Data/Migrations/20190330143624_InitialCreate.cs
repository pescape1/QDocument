        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortTitle = table.Column<string>(maxLength: 15, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Document_AspNetUsers_CreationUser",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentApproval", x => new { x.DocumentID, x.JobID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserTokens_Id",
                table: "AspNetUserTokens",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_Document_CreationUser",
                table: "Document",
                column: "CreationUser");
